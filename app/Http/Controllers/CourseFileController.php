...
class CourseFileController extends Controller
{
    ...
    public function index($studentId, $courseId)
    {
        ...
        return view('coursefile.index') ->withTitle($title) ->withFiles($files);
    }
    ...
    public function create($studentId, $courseId)
    {
        ...
        return view('coursefile.create') ->withTitle($title) ->withStudent($student)
            ->withCourse($course);
    }
    ...
    public function edit($studentId, $courseId, $id)
    {
        ...
        return view('coursefile.edit') ->withTitle($title) ->withStudent($student)
